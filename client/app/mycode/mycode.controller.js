...
angular.module('koodainApp')
   ...
   */
  .controller('MycodeCtrl', function ($scope,  $uibModal, $stateParams, $resource, $http, $location, $state, Notification, Upload, project, files, resources, apitocode, deviceManagerUrl, apiParser) {
